					...
					<div class="col-sm-8">
						...
						<div class="cart-row">	
							<ul class="nav nav-tabs" role="tablist">
							  ...
							  <li class="nav-item">
							    <a class="nav-link link-pesanan" data-toggle="tab" href="#pesanan" role="tab">Pesanan</a>
							  </li>
							...
							<div class="tab-content">
							  <div class="tab-pane active" id="keranjang" role="tabpanel">
								  <div class="cart-row2">
									...
									<div class="cart-harga row">
								 		<label for="total" class="col-form-label col-sm-1 offset-sm-1">Total</label>
								 		<div class="col-sm-3">
								 			<input type="text" name="totalcart" class="form-control form-control-lg totalcart input-format" value=0 readonly>	
								 		</div>
								 		<div class="col-sm-5">	
								 			<button type='button' class="btn btn-outline-info btn btn-order btn-lg">Pesan
	 		...
	 		<div class="modal-dialog ">
			    <div class="modal-content">
			      ...
			      <div class="modal-body info-body">
			        	Anda telah tutup bill, silahkan membayar di kasir. Terimakasih atas kunjungan anda 
			      </div>
...
$('.table-makanan,.table-minuman').on('click','tr',function(){
	...
	// JIKA BELUM ADA DIKERANJANG, TAMBAHKAN DIKERANJANG LALU HITUNG TOTAL
		...
		success:function(data){
			...
			// VALUE TOTAL	
			var tot=parseInt($('.totalcart').val())
...
$('.btn-bayar').click(function(){
	...
	$.ajax({
	    url:'function/prosestransaksi.php',	    // ISI TBL PENJUALAN
...
$('.btn-order').click(function(){
	...
	getpesanan();
	$('.link-pesanan').tab('show')

	showAlert()
})

$('.link-pesanan').on('shown.bs.tab', function(event){
    refresh=true;
});
$('.link-pesanan').on('hidden.bs.tab', function(event){
    refresh=false;
});			
